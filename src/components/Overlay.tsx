        ...
        <div className="absolute inset-0 pointer-events-none z-10 flex flex-col justify-center text-white mix-blend-difference">
            ...
            >
                <div className="text-center">
                    <h1 className="text-6xl md:text-8xl font-bold tracking-tight mb-4">{portfolioData.personal.name}.</h1>
                    <p className="text-xl md:text-2xl font-light text-gray-300">{portfolioData.personal.role}</p>
                </div>
            </motion.div>
            ...
            >
                <div className="max-w-2xl">
                    <h2 className="text-5xl md:text-7xl font-bold leading-tight">Expert in <br /><span className="text-blue-500">VMware Automation</span> & Orchestration.</h2>
                </div>
            </motion.div>
            ...
            >
                <div className="max-w-2xl">
                    <h2 className="text-5xl md:text-7xl font-bold leading-tight">Building scalable <br /><span className="text-purple-500">VCF Solutions</span> for Enterprise.</h2>
                </div>
            </motion.div>
        </div>
    );
