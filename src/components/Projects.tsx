                    ...
                    <AnimatePresence mode="popLayout">
                        {visibleProjects.map((project, index) => (
                            <motion.div
                                ...
                                viewport={{ once: true }}
                                className={`group relative rounded-3xl overflow-hidden cursor-pointer border border-white/10 bg-white/5 backdrop-blur-md min-h-[320px] aspect-[4/3] ${project.span}`}
                                        ...
                                        <div className="w-full md:w-3/5 p-8 md:p-12 bg-[#121212]">
                                            ...
                                            >
                                                ...
                                                <div className="flex gap-4 pt-4 border-t border-white/10">
                                                    ...
                                                    >
                                                        {selectedProject.id === 'vro-editor-resizer' ? 'Visit Chrome Webstore' : 'Visit Website'}
